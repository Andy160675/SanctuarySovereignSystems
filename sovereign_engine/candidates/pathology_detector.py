...
from engine.signals.typed_signal import TypedSignal, SignalType, create_signal, AuthorityLevel
...
class PathologyDetector:
    ...
    Does NOT act — only observes and reports.
    """
    ...
    def check_chain_integrity(self, integrity_valid: bool) -> list[PathologyAlert]:
        """Monitor hash chain integrity — constitutional level."""
        alerts = []
    ...
    def _record_alert(self, alert: PathologyAlert) -> None:
        """Log the alert — passive observation only."""
