...
T0: ADVISORY    â€” Manual Only. Human decides, human executes.
T1: CONDITIONAL â€” Auto-check, Manual trigger. System recommends, human approves.
T2: PRE_APPROVED â€” Automatic within bounds. System executes within pre-defined limits.
T3: AUTO_EXECUTABLE â€” Immediate autonomous response. Defense-grade automation.
...
# Trust class â†’ minimum authority required to assign
TRUST_AUTHORITY_MAP = {
...
class TrustToActionInterface:
    ...
    def evaluate(
        ...
        This is a MANDATORY step â€” no bypass permitted.
        """
