...
Signal â†’ Type â†’ Level â†’ Authority
...
# Immutable mapping: SignalType â†’ minimum AuthorityLevel
...
class TypedSignal:
    ...
    Frozen (immutable) after creation â€” Axiom I enforcement.
    """
    ...
    def __post_init__(self):
        """Compute evidence hash on creation â€” Axiom I: immutable evidence."""
    ...
    def validate(self) -> bool:
        ...
        if required_authority is None:
            return False  # Unrepresentable signal type â€” Axiom III
        authority_rank = {
